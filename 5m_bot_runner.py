...
def run_bot():
    ...
    BOT_SCRIPT = "bot-5min.py"
    
    # CRITICAL: Use the SAME Python executable
    python_cmd = sys.executable
    
    # Get command line arguments (excluding the script name)
    # If you run "python 5m_bot_runner.py --live", this captures ['--live']
    ...
    while True:
        ...
        try:
            ...
            env["MARKET_SLUG_PREFIX"] = "btc-updown-5m"
            env["MARKET_5M_INTERVAL_SECONDS"] = "300"
            env["MARKET_5M_SLUG_PREFIX"] = "btc-updown-5m"
            env.setdefault("TRADE_JOURNAL_5M_PATH", "trade_journal_5min.jsonl")
            env.setdefault("PAPER_TRADES_5M_PATH", "paper_trades_5min.json")
